...
const segregateEvenOdd = (arr) => {
    ...
    while (evenLIndex < oddRIndex) {
        ...
        if (arr[evenLIndex] % 2 === 0 && arr[oddRIndex] % 2 === 0 && evenLIndex < oddRIndex) {
            evenLIndex++;
        }
        if (arr[evenLIndex] % 2 == 1 && arr[oddRIndex] % 2 == 1 && evenLIndex < oddRIndex) {
            oddRIndex--;
        }
        if (arr[evenLIndex] % 2 == 1 && arr[oddRIndex] % 2 === 0 && evenLIndex < oddRIndex) {
